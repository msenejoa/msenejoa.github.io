...
const Profile = (props) => {
  ...
  return (
    <div>
      <div style={styles.picture} className='profileImg'>
        <img
          role='presentation'
      ...
      <h1 style={styles.hStyle} className='text-center'>
        {profileObj.name}
      </h1>
      <h2 style={styles.body} className='text-center'>
        {profileObj.label}
      </h2>
      ...
      <ul className='list-unstyled contact-links text-center'>
        ...
        <li>
          <a style={styles.location} href={`mailto:${profileObj.email}`}>
            {profileObj.email}
          </a>
        </li>
      </ul>
      ...
      <ul className='profileLinks list-inline text-center'>
        <li>
          <a
            ...
            href={'https://www.linkedin.com/in/senejoa/'}
          ></a>
        </li>
        <li>
          <a
      ...
      <p style={styles.bodyInfo}>
        ...
        <a href='https://github.com/msenejoa/msenejoa.github.io'>
          my Github repo
        </a>
        .
      </p>
